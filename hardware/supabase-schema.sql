...
revoke all on table public.products, public.product_images,
  ...
  public.support_messages, public.payment_webhook_events, public.payment_checkout_attempts,
...
revoke all on sequence public.products_id_seq, public.product_images_id_seq,
  ...
  public.purchase_order_items_id_seq, public.support_messages_id_seq from anon, authenticated;
